...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.2.2-lightgrey" alt="v0.2.2" />
</p>
...
- 💡 **主动建议** — 规则引擎 + LLM 语义分析，检测跨论文模式/知识空白/缺失论文，Wiki Browser 内联展示
...
- 💡 **Proactive Suggestions** — Rule engine + LLM semantic analysis, detects cross-paper patterns / knowledge gaps / missing papers
